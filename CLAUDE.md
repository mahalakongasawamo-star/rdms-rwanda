...
- **Flush-left text alignment.** All body copy, headings, eyebrows, pull-quotes, info-card descriptions, value descriptions, captions must be `text-align: left`. No centered or justified text. Exception only if explicitly requested. Reason: machine-readability for AI scrapers and screen readers.
